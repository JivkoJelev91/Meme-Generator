...
class Memes extends Component {
    ...
    handleFontSize = (event) => {
        if(event.target.value != undefined){
            this.setState({
                [event.target.nameInput]: event.target.value,
                active: false
            });
        }
    }
            ...
            <div className="wrapper">
                <div className="form">
                    ...
                    <div>
                        ...
                        <input type="number" nameInput="topFontSize" onChange={this.handleFontSize}/>
                    </div>
                    <div>
                        <label>Bottom text</label>
                        <input type="text" name="bottomText" onChange={this.handleInput}/>
                        <label>Font Size Bottom Text</label>
                        <input type="number" nameInput="bottomFontSize" onChange={this.handleFontSize}/>
                    </div>
                    <div>
                        <button 
