            ...
            <div className="wrapper">
                <div className="form">
                    ...
                    <div>
                        ...
                        <input type="number" name="topFontSize" onChange={this.handleFontSize(this.state.topFontSize)}/>
                    </div>
                    <div>
                        <label>Bottom text</label>
                        <input type="text" name="bottomText" onChange={this.handleInput}/>
                        <label>Font Size Bottom Text</label>
                        <input type="number" name="bottomFontSize" onChange={this.handleFontSize(this.state.bottomFontSize)}/>
                    </div>
                    <div>
                        <button 
